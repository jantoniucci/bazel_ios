...
_SETTINGS = {
	"arm64-apple-ios-simulator app.app/app": {
		"c": "-iquote$(PROJECT_DIR) -iquote$(PROJECT_DIR)/bazel-out/ios-sim_arm64-min17.0-applebin_ios-ios_sim_arm64-dbg-ST-3ad36ab8bf9c/bin -O0 -DDEBUG=1 -fstack-protector -fstack-protector-all"
	}
}
